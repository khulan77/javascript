...
if (appp2 == 0 || appp2 == 9) {
  console.log("baasan");
} else if (appp2 == 1 || appp2 == 8) {
  console.log("davaa");
} else if (appp2 == 2 || appp2 == 7) {
  console.log("mygmar");
} else if (appp2 == 3 || appp2 == 6) {
  console.log("lhagva");
} else {
  console.log("pvrev");
}
...
if (90 <= too && too <= 100) {
  console.log(too, "A");
} else if (80 <= too && too <= 90) {
  console.log(too, "B");
} else if (70 <= too && too <= 80) {
  console.log(too, "C");
}

//4//
const cold = "23";
console.log(cold[0] * cold[1]);

//5//
const cold2 = 986;
const first = parseInt(cold2 / 100);
const second = parseInt(parseInt(cold2 % 100) / 10);
const third = cold2 % 10;
...
// const say4 = 2;
// const say5 = 6;
// const say6 = 7;// 1–7 хооронд тоо оруулна
// let weekNumber = 5;
// let dayName;
...
//11 Өгөгдсөн 3 тоогоор талаа хийсэн гурвалжинг байгуулж болох бол YES үгүй бол NO гэж хэвлэ. (Example: 3 4 5, Result: YES)//
let sn1 = 4;
sn2 = 7;
sn3 = 9;

if (sn1 + sn2 > sn3 && sn2 + sn3 < sn1 && sn1 + sn3) {
  console.log("Yes");
} else {
  console.log("NO");
}
